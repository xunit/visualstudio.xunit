...
[Command(Name = "build", Description = "Build utility for xUnit.net VSTest Adapter")]
[HelpOption("-?|-h|--help")]
public class BuildContext
{
	...
	{
		WriteLineColor(ConsoleColor.DarkGray, $"EXEC: {name} {redactedArgs ?? args}{Environment.NewLine}");
